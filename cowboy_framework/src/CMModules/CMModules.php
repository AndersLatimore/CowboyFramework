<?php
/**
* A model for managing Cowboy modules.
*
* @package CowboyCore
*/
...
* Properties
*/
  private $cowboyCoreModules = array('CCowboy', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $cowboyCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
...
*/
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isCowboyCore'] = in_array($rc->name, $this->cowboyCoreModules);
      $details['isCowboyCMF'] = in_array($rc->name, $this->cowboyCMFModules);
