...
*/
   public static function Markdown($text) {
    require_once(__DIR__.'/php_markdown_extra_1.2.5/Michelf/Markdown.php');
...
*/
   public static function MarkdownExtra($text) {
    require_once(__DIR__.'/php_markdown_extra_1.2.5/Michelf/MarkdownExtra.php');
    return Markdown($text);
  }
...
EOD;
        ...
        case 'BASEURL': return CCowboy::Instance()->request->base_url; break;
