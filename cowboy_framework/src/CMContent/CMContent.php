    ...
    switch($action) {
      case 'install':
        try {
          ...
          $this->db->ExecuteQuery(self::SQL('insert content'), array('about', 'page', 'About page', "This is a demo page, this could be your personal about-page.\n\nThe Cowboy Framework is based on <a href='https://github.com/mosbth/lydia.git'>Lydia</a> is used as a tool to educate in MVC frameworks.", 'htmlpurify', $this->user['id']));
          $this->db->ExecuteQuery(self::SQL('insert content'), array('test', 'page', 'Test page', "This is a test page, just trying things out.\n<img src='../site/themes/mytheme/img/andy1.JPG'>\nMore testing going on here...", 'htmlpurify', $this->user['id']));
